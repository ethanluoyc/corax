import time
from typing import Any, Generic, Iterator, List, Optional, Sequence
...
class DefaultJaxLearner(
    ...
    def __init__(
        ...
        self._sgd_step = jax.jit(self._learner_core.step)
    ...
    def step(self):
        ...
        self._state, metrics = self._sgd_step(self._state, sample)
