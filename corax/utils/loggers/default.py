...
from corax.utils.loggers import aggregators
from corax.utils.loggers import asynchronous as async_logger
from corax.utils.loggers import base
from corax.utils.loggers import filters
from corax.utils.loggers import terminal
...
def make_default_logger(
    ...
    serialize_fn: Optional[Callable[[Mapping[str, Any]], Any]] = base.to_numpy,
    steps_key: str = "steps",
) -> base.Logger:
